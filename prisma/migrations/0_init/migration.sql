...
-- AddForeignKey
ALTER TABLE "accountant" ADD CONSTRAINT "accountant_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "customer_service_representative" ADD CONSTRAINT "customer_service_representative_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
